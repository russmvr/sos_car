...
class PageManipulatorEvacuator extends XPage {
  final UserInfoSosCar userInfo;
  final CarSosCar carInfo;
  PageManipulatorEvacuator([this.userInfo, this.carInfo]);

  @override
  _PageManipulatorEvacuatorState createState() => _PageManipulatorEvacuatorState();
}

class _PageManipulatorEvacuatorState extends XPageState<PageManipulatorEvacuator, Event, State> {
  _PageManipulatorEvacuatorState() : super(Controller());
