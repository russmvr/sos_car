...
class PageCargoEvacuator extends XPage {
  final UserInfoSosCar userInfo;
  final CarSosCar carInfo;
  PageCargoEvacuator([this.userInfo, this.carInfo]);

  @override
  _PageCargoEvacuatorState createState() => _PageCargoEvacuatorState();
}

class _PageCargoEvacuatorState extends XPageState<PageCargoEvacuator, Event, State> {
  _PageCargoEvacuatorState() : super(Controller());
  final _lengthController = TextEditingController();
  final _platformWidthController = TextEditingController();
  final _carryingController = TextEditingController();
  final _formKeyCargoInfo = GlobalKey<FormState>();
  String valuePlatformChoose;
  String valueVehicleCategoryChoose;
  List platformTypeList = ['Сдвижная1', 'Сдвижная2', 'Сдвижная3'];
    ...
    return Scaffold(
      body: GestureDetector(
        ...
        child: ListView(
          children: [
            SizedBox(height: 10),
            Center(child: Text('Грузовой', style: TextStyle(
                color: MyColors.black,
                fontFamily: 'Inter', fontWeight: MyParams.textBold,
                fontSize: 20))),
            SizedBox(height: 60),
            Form(
              key: _formKeyCargoInfo,
              child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: DropdownButtonFormField(
                            ...
                            items: platformTypeList.map((valueItem) {
                              return DropdownMenuItem(
                                value: valueItem,
                                child: Text(valueItem),
                              );
                ...
                Container(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        ...
                        if (!_formKeyCargoInfo.currentState
                            .validate()) {
                          return;
                        }
                        ...
                        CargoEvacuator evacuator = CargoEvacuator(
                          evacuatorType: 'Cargo',
                          ...
                          boomLength: null,);
                        UserSosCar<CargoEvacuator> allUserInfo = UserSosCar(
