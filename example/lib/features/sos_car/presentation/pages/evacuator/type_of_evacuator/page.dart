...
class PageTypeEvacuator extends XPage {
  final UserInfoSosCar userInfo;
  final CarSosCar carInfo;
  PageTypeEvacuator([this.userInfo, this.carInfo]);

  @override
  _PageTypeEvacuatorState createState() => _PageTypeEvacuatorState();
}

class _PageTypeEvacuatorState
    extends XPageState<PageTypeEvacuator, Event, State> {
  _PageTypeEvacuatorState() : super(Controller());
