...
class PageEasyEvacuator extends XPage {
  final UserInfoSosCar userInfo;
  final CarSosCar carInfo;
  PageEasyEvacuator([this.userInfo, this.carInfo]);

  @override
  _PageEasyEvacuatorState createState() => _PageEasyEvacuatorState();
}

class _PageEasyEvacuatorState extends XPageState<PageEasyEvacuator, Event, State> {
  _PageEasyEvacuatorState() : super(Controller());
                ...
                Container(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        ...
                        EasyEvacuator evacuator = EasyEvacuator(
                          evacuatorType: 'Easy',
                          ...
                          boomLength: null,);
                        UserSosCar<EasyEvacuator> allUserInfo = UserSosCar(
