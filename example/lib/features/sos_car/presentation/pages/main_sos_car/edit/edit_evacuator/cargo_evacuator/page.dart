...
class PageEditCargoEvacuator extends XPage {
  final AllUserInfoModel allInfo;
  PageEditCargoEvacuator(this.allInfo);

  @override
  _PageEditCargoEvacuatorState createState() => _PageEditCargoEvacuatorState();
}

class _PageEditCargoEvacuatorState extends XPageState<PageEditCargoEvacuator, Event, State> {
  _PageEditCargoEvacuatorState() : super(Controller());
                ...
                Container(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        ...
                        final Evacuator evacuatorCargoNewInfo = Evacuator(
                            evacuatorType: 'Cargo',
                        ...
                        addEvent(UpdateEvacuatorCargoInfoEvent(widget.allInfo, evacuatorCargoNewInfo));
                      },
                    )),
              ],
            ),
